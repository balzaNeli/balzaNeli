...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=500&lines=Desenvolvendo+na+web+desde+o+início+%F0%9F%9A%80;HTML+%7C+CSS+%7C+Python+%7C+Portugol;Apaixonado+por+tecnologia+e+hardware)](https://git.io/typing-svg)
...
Estudante de TI com foco em **programação web** e **algoritmos**. Gosto de construir interfaces do zero, entender como as coisas funcionam por dentro e explorar o máximo que a tecnologia pode oferecer — mesmo com recursos limitados.
...
- ⚙️ Interesse em hardware, IoT e sistemas embarcados
- 📍 Brasil
...
| [🖩 "Calculadora Foda"]([https://github.com/balzaNeli/CPP/calculadoraFODA.cpp](https://github.com/balzaNeli/CPP/blob/main/calculadoraFODA.cpp)) | Calculadora em C++ | CPP |
